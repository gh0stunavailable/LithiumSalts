#ifndef __LithiumSalts_CONFIG_H__
#define __LithiumSalts_CONFIG_H__
...
public:
    ...
    const char *filepath = "/LithiumSalts.conf";
    ...
    // Wifi
    Credential webUI = {"admin", "LithiumSalts"};
    WiFiCredential wifiAp = {"LithiumSaltsNet", "LithiumSaltsnet"};
    ...
    std::vector<QrCodeEntry> qrCodes = {
        {"LithiumSalts AP", "WIFI:T:WPA;S:LithiumSaltsNet;P:LithiumSaltsnet;;"},
        {"LithiumSalts Wiki", "https://github.com/pr3y/LithiumSalts/wiki"},
        {"LithiumSalts Site", "https://LithiumSalts.computer"},
