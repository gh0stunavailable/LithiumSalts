...
void RFMenu::optionsMenu() {
    ...
    if(LithiumSaltsConfig.rfModule==CC1101_SPI_MODULE) txt+=" (CC1101)"; // Indicates if CC1101 is connected
    else txt+=" Tx: " + String(LithiumSaltsConfig.rfTx) + " Rx: " + String(LithiumSaltsConfig.rfRx);
...
void RFMenu::drawIcon(float scale) {
    ...
    // Body
    tft.fillCircle(iconCenterX, iconCenterY - radius, radius, LithiumSaltsConfig.priColor);
    tft.fillTriangle(
