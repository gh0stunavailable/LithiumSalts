...
void _setup_gpio()
{
  ...
  LithiumSaltsConfig.rfModule = CC1101_SPI_MODULE;
  LithiumSaltsConfig.rfidModule = PN532_I2C_MODULE;

  LithiumSaltsConfig.irRx = RXLED;
  LithiumSaltsConfig.irTx = LED;
}
...
void checkReboot()
{
  ...
  if (digitalRead(UP_BTN) == BTN_ACT && digitalRead(DW_BTN) == BTN_ACT)
  {
    ...
    delay(30);
    tft.fillRect(60, 12, tftWidth - 60, tft.fontHeight(1), LithiumSaltsConfig.bgColor);
  }
#endif
}