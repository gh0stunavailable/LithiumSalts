...
public:
    ...
    void draw(float scale = 1) {
        if(rotation!=LithiumSaltsConfig.rotation) resetCoordinates();
    ...
    void drawArrows(float scale = 1) {
        tft.fillRect(arrowAreaX, iconAreaY, arrowAreaW, iconAreaH, LithiumSaltsConfig.bgColor);
        tft.fillRect(tftWidth - arrowAreaX - arrowAreaW, iconAreaY, arrowAreaW, iconAreaH, LithiumSaltsConfig.bgColor);
...
protected:
    ...
    void clearIconArea(void) {
        tft.fillRect(iconAreaX, iconAreaY, iconAreaW, iconAreaH, LithiumSaltsConfig.bgColor);
    }
    ...
    void resetCoordinates(void) {
        ...
        rotation = LithiumSaltsConfig.rotation;
    }
};
